            ...
            <td>
                <table style="max-width: 800px; width: 100%; background: #fff; padding: 0; margin: 50px auto 0; border-spacing: 0px; border-collapse: collapse;">
                    <thead>
                        ...
                        <tr>
                            <td>
                                <p style="padding: 0; margin: 40px 0 0 0; font-size: 16px; color: #000; text-align: center;">Hi, {{$comment_details->toUser->name}}</p>
                                <p style="padding: 0; margin: 0; font-size: 16px; color: #000; text-align: center;">{{$comment_details->fromUser->name}} message you</p>
                            </td>
                        </tr>
                        <tr>
                                            ...
                                            <td>
                                                <table cellspacing="0" cellpadding="0" style="max-width: 740px; width: 100%; background: #f3f3f3; padding: 0; margin: 0 auto; border-spacing: 0px; border-collapse: collapse; border-radius: 10px;">
                                                    <tbody>
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" style="width: 370px; background: #f3f3f3; padding: 0; margin: 0 auto; border-spacing: 0px; border-collapse: collapse;">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td style="font-size: 14px; text-align: left; padding: 4px 0; color: #686868; font-size: 15px;">{{$comment_details->fromUser->name}}</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" style="width: 370px; background: #f3f3f3; padding: 0; margin: 0 auto; border-spacing: 0px; border-collapse: collapse;">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td style="font-size: 14px; text-align: left; padding: 4px 0; color: #686868; font-size: 15px;">{{$comment_details->fromUser->email}}</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="padding: 0 15px;">Massage :</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding: 0 15px 20px 15px; color: #686868; font-size: 15px;">{{@$comment_details->comment}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
