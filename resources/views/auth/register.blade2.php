        ...
        <div class="banner-new-rgt">
            <div class="flip-container">
                <div class=" flipper" id="flipper">
                    <div class="log-reg-box front">
                        <span class="log-logo">
                            <img class="img-block" src="images/american-model.png" alt="">
                        </span>
                        {{-- {{route('login')}} --}}
                        <p>Already have an account? <a href="#" class="log-btn-new" id="loginButton">login</a></p>
                        <ul class="sgn-text-icon d-flex align-items-center">
                            <li><h4>Sign up</h4></li>
                            <li><img class="img-block" src="images/icons.png" alt=""></li>
                        </ul>
                    ...
                    <div class="log-reg-box back">
                        <span class="log-logo">
                            <img class="img-block" src="images/american-model.png" alt="">
                        </span>
                        {{-- {{route('login')}} --}}
                        <p>Already have an account? <a href="#" class="log-btn-new" id="registerButton">Register</a></p>
                        <ul class="sgn-text-icon d-flex align-items-center">
                            <li><h4>Sign up</h4></li>
                            <li><img class="img-block" src="images/icons.png" alt=""></li>
                        </ul>
