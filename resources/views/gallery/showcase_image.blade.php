        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="gelleries-page-head">
                    <h3 class="clr-red">Gallery <br>{{$image_category->name}}</h3>
                </div>
            </div>
                ...
                <div class="col-auto">
                    <div class="top-filter-gallery">
                        <ul class="filter-list d-flex flex-wrap">
                            <li class="{{Route::currentRouteName() == 'gallery.album.list' || Route::currentRouteName() == 'gallery.showcase.image.list' ? 'active' : ''}}"><a href="{{route('gallery.album.list')}}">Showcases</a></li>
