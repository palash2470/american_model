            ...
            <div class="col-12 connectedSortable">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Poll Group</h3> 
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question" class="form-control" id="question" value="" placeholder="Poll Question">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="user_ids[]">
                                                                ...
                                                                @forelse ($users as $user)
                                                                    <option value="{{$user->id}}">{{$user->name}} ({{@$user->category->name}})</option>
                                                                @empty
