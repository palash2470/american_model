            ...
            <td>
                <table style="max-width: 800px; width: 100%; background: #fff; padding: 0; margin: 50px auto 0; border-spacing: 0px; border-collapse: collapse;">
                    <thead>
                        ...
                        <tr>
                            <td>
                                <p style="padding: 0; margin: 40px 0 0 0; font-size: 16px; color: #000; text-align: center;">Hi, Admin</p>
                                <p style="padding: 0; margin: 0; font-size: 16px; color: #000; text-align: center;">A New User registered on the website </p>
                            </td>
                        </tr>
                    </thead>
                </table>
