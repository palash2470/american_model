            ...
            <td>
                <table style="max-width: 800px; width: 100%; background: #fff; padding: 0; margin: 50px auto 0; border-spacing: 0px; border-collapse: collapse;">
                    <thead>
                        ...
                        <tr>
                            <td>
                                <p style="padding: 0; margin: 40px 0 0 0; font-size: 16px; color: #000; text-align: center;">Hi, {{@$follow->followingsUser->name}}</p>
                                <p style="padding: 0; margin: 0; font-size: 16px; color: #000; text-align: center;">{{@$follow->followersUser->name}} following you</p>
                            </td>
                        </tr>
                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width: 40px; font-size: 14px; text-align: left; padding: 10px; color: #000;">
                                                                <img style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%;" src="{{url('/img/user/profile-image/'.$follow->followersUser->userDetails->profile_image)}}" alt="">
                                                            </td>
                                                            <td style="font-size: 14px; text-align: left; padding: 10px; color: #686868; font-size: 15px;">{{@$follow->followersUser->name}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                        ...
                        <tr>
                            <td>
                                <p style="padding: 0; margin: 10px 0 0 0; font-size: 16px; color: #000; text-align: center;">
                                    <a href="{{url('/profile/'.$follow->followersUser->category->slug.'/'.$follow->followersUser->name_slug)}}" style="background-color: #000; color: #fff; display: inline-block; font-size: 14px; height: 30px; line-height: 30px; padding: 0 10px; text-decoration: none; border-radius: 5px;">view profile</a>
                                </p>
                            </td>
                        </tr>
                    </thead>
